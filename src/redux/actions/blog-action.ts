...
export const FIREBASE_BLOG_REQUEST = 'BlogFirebaseRequestAction';
...
export const FIREBASE_BLOG_RESPONSE = 'BlogFirebaseResponseAction';
...
export const FIREBASE_BLOG_ERROR = 'BlogFirebaseErrorAction';
