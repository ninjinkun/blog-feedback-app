...
const firebaseEntities: ItemEntity[] = [
  {
    ...
    published: new Timestamp(1544769832, 0),
    counts: {
      facebook: { count: 4, timestamp: new Timestamp(1544787808, 337000000) },
      hatenabookmark: { count: 6, timestamp: new Timestamp(1544787808, 337000000) },
    },
    prevCounts: {
      facebook: { count: 3, timestamp: new Timestamp(1544787295, 410000000) },
      hatenabookmark: { count: 4, timestamp: new Timestamp(1544775366, 395000000) },
    },
  },
];
