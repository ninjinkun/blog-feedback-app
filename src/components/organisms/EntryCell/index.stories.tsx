...
storiesOf('organisms/EntryCell', module)
    .add('default', () => <Background><EntryCell favicon={favicon} title={'一休のDB移行'} counts={counts} url={''} animate={false} /></Background>)
    .add('animate', () => <Background><EntryCell favicon={favicon} title={'一休のDB移行'} counts={counts} url={''} animate={true} /></Background>);
